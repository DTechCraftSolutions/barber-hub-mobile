...
export function Home({ navigation }: any) {
    ...
    return (
        <View className="w-full px-2 h-full pt-8 bg-black">
            <Header/>
            <DateComponent />
            <Text style={{ fontFamily: 'Oswald_600SemiBold' }}
             className="text-white text-lg mt-4">Sua Barbearia Favorita</Text>
             <FavoriteBarbershopCard />
             <Text style={{ fontFamily: 'Oswald_600SemiBold' }}
             className="text-white text-lg mt-4">Próximo agendamento</Text>
             <ScheduleCard />
